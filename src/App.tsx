...
const tocItems = [
  ...
  { id: "purchases", label: "4. Purchases and Payment" },
  ...
  { id: "advertisers", label: "11. Advertisers" },
  { id: "sitemanage", label: "12. Services Management" },
  { id: "privacy", label: "13. Privacy Policy" },
  { id: "terms", label: "14. Term and Termination" },
  ...
  { id: "corrections", label: "18. Corrections" },
  { id: "disclaimer", label: "19. Disclaimer" },
  { id: "liability", label: "20. Limitations of Liability" },
  { id: "indemnification", label: "21. Indemnification" },
  { id: "userdata", label: "22. User Data" },
  {
    id: "electronic",
    label: "23. Electronic Communications, Transactions, and Signatures",
  },
  { id: "california", label: "24. California Users and Residents" },
  { id: "misc", label: "25. Miscellaneous" },
  { id: "contact", label: "26. Contact Us" },
];
    ...
    <div className="policy-container">
      ...
      <main className="container">
        <section className="policy-card">
          ...
          <p>
            We are <strong>Isotope Core</strong> (&quot;<strong>Company</strong>
            ,&quot; &quot;<strong>we</strong>,&quot; &quot;<strong>us</strong>
            ,&quot; &quot;<strong>our</strong>&quot;), a company registered in
            Ukraine at Sichovykh Striltsiv st., Stara Syniava, 29000.
          </p>
          <p>
            We operate the mobile application <strong>Unit Converter 3D</strong>{" "}
          ...
          <p>
            This mobile application is an offline unit converter that helps
            users quickly and conveniently convert units of measurement, while
            the basic version contains ads (AdMob) which can be disabled via a
            paid subscription.
          </p>
          <p>
            ...
            or by mail to Sichovykh Striltsiv st., Stara Syniava, 29000,
            Ukraine.
          </p>
          <p>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (&quot;
            <strong>you</strong>&quot;), and Isotope Core, concerning your
          ...
          <p>
            We may update these Legal Terms by updating the legal terms page on
            our website. Your continued use of the App constitutes acceptance of
            the updated terms.
          </p>
          <p>
          ...
          {/* 4 */}
          <h2 id="purchases">4. Purchases and Payment</h2>
          ...
          <ul>
            {contributionWarranties.map((item, index) => (
              <li key={index}>{item}</li>
            ))}
          </ul>
          <p>
          ...
          {/* 10 */}
          <h2 id="mobile">10. Mobile Application License</h2>
          <h3>Use License</h3>
          <p>
          ...
          <p>
            ...
            Policy:{" "}
            <a
              href="https://isotopecore.github.io/unit-converter-3d-privacy-policy"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://isotopecore.github.io/unit-converter-3d-privacy-policy
            </a>
            . By using the Services, you agree to be bound by our Privacy
            Policy, which is incorporated into these Legal Terms. Please be
            advised the Services are hosted in Ukraine. If you access the
            ...
            that differ from applicable laws in Ukraine, then through your
            continued use of the Services, you are transferring your data to
            Ukraine, and you expressly consent to have your data transferred to
            and processed in Ukraine. Further, we do not knowingly accept,
          ...
          <p>
            ...
            laws of Ukraine. Isotope Core and yourself irrevocably consent that
            the courts of Ukraine shall have exclusive jurisdiction to resolve
          ...
          <p>
            ...
            the jurisdiction of the Ukraine courts. Isotope Core shall also
